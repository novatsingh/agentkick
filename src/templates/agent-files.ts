...
type WriteAgentFilesOptions = {
  includeWorkflowMemory?: boolean;
};

export function writeAgentFiles(cwd: string, profile: ProjectProfile, options: WriteAgentFilesOptions = {}) {
...
function writeWorkflowMemoryFiles(cwd: string, profile: ProjectProfile) {
  writeFile(
    cwd,
    "CURRENT_TASK.md",
    `# Current Task
